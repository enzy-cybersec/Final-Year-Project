param(
    [string]$LocalIP = "192.168.56.150",
    [string]$DCIP    = "192.168.56.10"
)

if (!$LocalIP) {
        $DCIP = "192.168.56.10"
	$LocalIP = "192.168.56.150"
}


$domainName  = "fyp.lab"
$joinUser    = "FYP\Administrator"
$joinPwd     = "P@ssw0rd123!"   # same as DC admin password
...
Write-Host "Configuring static IP on SRV01..."
...
Write-Host "Joining SRV01 to domain $domainName..."
